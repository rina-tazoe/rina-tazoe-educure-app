...
public class MainController {
    ...
    public String main(Model model) {
        ...
        if (authentication != null && authentication.getPrincipal() instanceof CustomUserDetails) { // ★ CustomUserDetails でキャスト ★
            CustomUserDetails userDetails = (CustomUserDetails) authentication.getPrincipal();
            String userName = userDetails.getDisplayName(); // ★ getDisplayName() でユーザー名を取得 ★
